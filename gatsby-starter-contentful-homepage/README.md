...
The UI components file `src/componentsX/ui.js` imports styles from `src/componentsX/ui.css.ts`. You can see how the theme and color values are being used in this file.

### Add your logo

![Logo](./docs/images/logo.png)

Replace the `src/componentsX/brand-logo.js` component with your own brand logo.
...
To further customize the look and feel of the homepage, edit the UI components in `src/componentsX/ui.js` and styles in `src/componentsX/ui.css.ts`.

### Customize section components

To customize any of the sections of the homepage, edit the relevant component in `src/components`.
Most of the styles for these components are handled with shared UI components in `src/componentsX/ui.js`.
...
1. Export the component from `src/componentsX/sections.js`

   ```js fileExt
   // src/componentsX/sections.js
